    ...
    return (
      ...
      >
        ...
        <g style={{ mixBlendMode: 'power' }} className="dark:opacity-80 dark:[mix-blend-mode:screen]">
          ...
          <circle cx="335" cy="230" r="100" fill="hsl(var(--chart-1) / 0.5)" />
          <circle cx="165" cy="230" r="100" fill="hsl(var(--accent) / 0.5)" />
        ...
        <text x="415" y="225" textAnchor="middle" className="font-bold text-lg">
          What You're Good At
        </text>
        <text x="415" y="245" textAnchor="middle" className="text-sm opacity-80">
          Your talents & skills
        </text>
        ...
        <text x="85" y="225" textAnchor="middle" className="font-bold text-lg">
          What The World Needs
        </text>
        <text x="85" y="245" textAnchor="middle" className="text-sm opacity-80">
