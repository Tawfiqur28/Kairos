  ...
  return (
    <>
      ...
      >
        ...
        <motion.div variants={itemVariants} whileHover={{ y: -5, transition: { type: 'spring', stiffness: 300 } }} className="md:col-span-2 lg:col-span-1">
              ...
              {hasMounted ? (
                <div className="space-y-4">
                  {hasActionPlan ? (
                    ...
                    <motion.div 
                      className="text-center p-4 border-2 border-dashed rounded-lg h-full flex flex-col justify-center"
      ...
      {hasMounted && isProfileComplete && (
        <motion.div 
          className="mt-8 p-6 bg-gradient-to-r from-primary/5 to-blue-50 dark:from-primary/10 dark:to-blue-900/10 rounded-xl border"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
